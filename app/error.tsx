...
export default function Error() {
  return (
    ...
    >
      <GridShape />
      <div
        className="md:mx-auto  mx-3 md:w-[630px]  rounded-sm p-12
       bg-white shadow-sm 
      ...
      >
        ...
        <h1
          className=" mt-2 mb-4 font-medium text-black capitalize
         md:text-4xl text-2xl"
        >
          500 - server error
        </h1>
        <p className=" text-center text-gray-700 text-[16px]">
          Sorry! Something went wrong on our server. we`er working to fix the
          issuse.
        </p>
